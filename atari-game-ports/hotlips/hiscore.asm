	;; FujiNet HighScoreEnabled code for Hot Lips
...
HFSLT3:	INY			; Increment current hiscore slot ptr.
	...
	CPY #$05		; Are we done with string comparison?
...
HSCROF:
	.byte 12, 20+12, 40+12, 60+12, 80+12, 100+12, 120+12, 140+12, 160+12, 180+12
