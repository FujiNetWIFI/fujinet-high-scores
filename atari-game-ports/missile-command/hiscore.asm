...
p1scr_store:	.ds 7
	...
	;; Persist score from screen data before we hit THE END
	;; where it gets obliterated.
...
hs1:	lda p1scr,x
	...
	cpx #$07
	bne hs1
hsd:	jmp L8BD3		; And continue to THE END
...
hiscore:
	...
	jsr $9053		; Draw bottom
	jsr $8CC9		; Draw arrows
