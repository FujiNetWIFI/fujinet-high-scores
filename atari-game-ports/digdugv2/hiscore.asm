	;; FujiNet High Score Enabled code for Digdug v2

chkey   equ $02FC
p1scr	equ $3F00		; internal RAM for p1scr
...
hiscore:
	...
	;; Convert P1 score to screen codes
