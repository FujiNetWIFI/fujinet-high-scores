/**
 * Grab high score from Donkey Kong, write to HTML
 *
...
void dkong(char *atr, char *html)
{
  unsigned char buf[256];
  FILE *fa, *fh;
  int i, offset;

  printf("Writing new dkong.html\n");
  ...
  fprintf(fh,"  <link rel=\"stylesheet\" type=\"text/css\" href=\"dkong.css\" media=\"screen\" />\n");
...
int main(int argc, char *argv[])
{
  if (argc < 3)
    {
      printf("%s <path-to-dkong-atr> <path-to-output-html>\n",argv[0]);
      return 1;
    }
