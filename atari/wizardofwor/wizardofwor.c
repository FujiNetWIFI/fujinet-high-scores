...
#define WIZARDOFWOR_SEEK_POS (0x16790)
...
void wizardofwor(char *atr, char *html)
{
  char buf[128];
  FILE *fa, *fh;
  int i, offset;

  printf("Writing new wizardofwor.html\n");
  ...
  fprintf(fh,"  <link rel=\"stylesheet\" type=\"text/css\" href=\"wizardofwor.css\" media=\"screen\" />\n");
...
int main(int argc, char *argv[])
{
  if (argc < 3)
    {
      printf("%s <path-to-wizardofwor-atr> <path-to-output-html>\n",argv[0]);
      return 1;
    }

  wizardofwor(argv[1],argv[2]);
